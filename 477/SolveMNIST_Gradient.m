...
for i = 1:num_iter                        
    ...
    convgsd(i) = norm(beta_grad,2); % <-- Correct this!!
    ...
    lenXsd(i)  = norm(beta_guess_iter(i+1,:) - beta_guess_iter(i,:),2); % <-- Correct this!!
    ...
    diffFsd(i) = norm(fcn_val_iter(i+1) -  fcn_val_iter(i),1); % <-- Correct this!!
